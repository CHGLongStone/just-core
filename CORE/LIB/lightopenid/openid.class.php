...
class LightOpenID
{
    ...
    function __construct($host)
    {
		...
		#echo __METHOD__.'@'.__LINE__.'_SERVER["REQUEST_URI"]['.$_SERVER['REQUEST_URI'].']<br>';
        $uri = rtrim(preg_replace('#((?<=\?)|&)openid\.[^&]+#', '', $_SERVER['REQUEST_URI']), '?');
        $this->returnUrl = $this->trustRoot . $uri;
		#echo __METHOD__.'@'.__LINE__.'uri['.$uri.']<br>';
		#echo __METHOD__.'@'.__LINE__.'this->trustRoot['.$this->trustRoot.']<br>';
		#echo __METHOD__.'@'.__LINE__.'$_SERVER["REQUEST_URI"]['.$_SERVER['REQUEST_URI'].']<br>';
    ...
    function __set($name, $value)
    {
        ...
        case 'identity':
			...
			#echo __METHOD__.'@'.__LINE__.'this->claimed_id['.$this->claimed_id.']<br>';
			#echo __METHOD__.'@'.__LINE__.'this->identity['.$this->identity.']<br>';
            break;
        case 'trustRoot':
        case 'realm':
    ...
    function validate()
    {
       echo __METHOD__.'@'.__LINE__.'<br>';
		...
		echo __METHOD__.'@'.__LINE__.'this->data<pre>'.var_export($this->data, true).'</pre>'.__METHOD__.'::'.__LINE__.'<br>';
        ...
        if (isset($this->data['openid_ns'])) {
			...
			echo __METHOD__.'@'.__LINE__.' $this->returnUrl['.$this->returnUrl.']<br>';
			echo __METHOD__.'@'.__LINE__.' $this->claimed_id['.$this->claimed_id.']<br>';
        ...
        if ($this->data['openid_return_to'] != $this->returnUrl) {
			...
			echo __METHOD__.'@'.__LINE__.'$this->data["openid_return_to"]['.$this->data['openid_return_to'].'] <br>$this->returnUrl['.$this->returnUrl.']<br>$this->claimed_id['.$this->claimed_id.']  <br>';
            return false;
        }
		...
		#
		echo __METHOD__.'::'.__LINE__.'server<pre>'.var_export($server, true).'</pre>'.'<br>';
		#echo 'params<pre>'.var_export($params, true).'</pre>'.__METHOD__.'::'.__LINE__.'<br>';
        $response = $this->request($server, 'POST', $params);
		echo __METHOD__.'@'.__LINE__.'response<pre>'.var_export($response, true).'</pre>'.'<br>';
